...
use HelpPC\NetteSecurity\Exception\BadCredentialsException;
use HelpPC\NetteSecurity\Exception\LogicException;

class SodiumPasswordEncoder implements EncoderInterface
{
